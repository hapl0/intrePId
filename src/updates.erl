...
list_left () -> 
    [
        ...
        #listitem{ class="active",body=#link{ text="Updates", url="updates" }},
...
right_body() -> 
    [
        #panel { style="margin: 50px 100px;", body=[
            #span { text="Hello from terminal.erl!" },

            #p{},
            #button { text="Command", postback=click },
...
event(click) ->
    wf:insert_top(placeholder, os:cmd("nmap localhost")).
